...
static struct s3cfb_lcd s6e8aa1_mipi_lcd = {
...
static struct s3cfb_lcd s6evr01_mipi_lcd = {
...
#endif
#if defined(CONFIG_FB_S5P_S6E8AA1)
	.lcd		= &s6e8aa1_mipi_lcd,
#endif
#if defined(CONFIG_FB_S5P_S6EVR01)
	.lcd		= &s6evr01_mipi_lcd,
#endif
...
#if defined(CONFIG_FB_S5P_S6E8AA1)
	dsim_lcd_info->lcd_panel_info = (void *)&s6e8aa1_mipi_lcd;
#endif

#if defined(CONFIG_FB_S5P_S6EVR01)
	dsim_lcd_info->lcd_panel_info = (void *)&s6evr01_mipi_lcd;
#endif
...
{
	return	(gpio_get_value(EXYNOS4_GPX1(1)) ? 0 : 1);
}

// Charger status indicate
...
#if defined(CONFIG_CHARGER_MAX8677)
#include <linux/power/max8677_charger.h>
static struct max8677_pdata max8677_pdata = {
	.cen 	= EXYNOS4_GPC1(4),		/* Charger Enable input */
	.uok 	= EXYNOS4_GPX1(1),		/* USB Power OK output */
	.chg 	= EXYNOS4_GPX0(7),		/* Charger status output */
	.done 	= EXYNOS4_GPX1(0),		/* USB Suspend Input (1: suspended) */
};

static struct platform_device max8677_device = {
	.name	= "max8677-charger",
	.id	= -1,
	.dev	= {
		.platform_data = &max8677_pdata
	},
};
#endif
...
MACHINE_START(ODROID_4X12, "SMDA2")
